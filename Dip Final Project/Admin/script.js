...
// Get all show modal buttons, overlay elements, close buttons, and cancel buttons
// Get all show modal buttons, overlay elements, close buttons, and cancel buttons
// const showButtons = document.querySelectorAll(".show-modal");
// const overlays = document.querySelectorAll(".overlay");
// const closeButtons = document.querySelectorAll(".close-btn");
// const cancelButtons = document.querySelectorAll(".can-btn");
...
// // Function to close modal when clicking on close button
...
// // Function to close modal when clicking on cancel button
