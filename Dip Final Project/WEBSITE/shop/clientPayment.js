document.addEventListener('DOMContentLoaded', () => {
    ...
    if (selectedProduct && Object.keys(selectedProduct).length > 0) {
        const itemTotalPrice = parseFloat(selectedProduct.price.replace('Rs.', '').replace(',', '')) * selectedProduct.quantity;
        totalPrice += itemTotalPrice;
        productIds.push(selectedProduct.id);
        productQuantities[selectedProduct.id] = selectedProduct.quantity;
            ...
            <div class="product" style="display: flex; align-items: center;">
                ...
                <div style="flex: 1; padding: 10px;">
                    <div style="display: flex; justify-content: space-between;">
                        ...
                        <p>Qty: ${selectedProduct.quantity}</p>
                    </div>
                </div>
                <div>
                    <p style="margin: 0; padding: 10px;">Rs${itemTotalPrice.toFixed(2)}</p>
